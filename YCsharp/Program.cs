...
namespace YCsharp {
    ...
    public class Program {
        static void Main(string[] args) {
            ...
            //}
            //var cmd = args[0];
            //string[] machineName = new[] { "CA", "CB", "CC", "DA", "DB", "DE_DF", "DM", "ED", "EJ", "EK_EL", "EP", "RC_RF", "RG", "SA", "SB", "SI_SG", "TA_RE", "TB_TG", "VA_VC", "VB_VG", "VD", "VE_VF", "VH_VI", "VJ_VK","EB","CD" };
            ...
            //    "192.168.139.66","192.168.140.66","192.168.142.66","192.168.144.66","192.168.146.66","192.168.149.66","192.168.178.66","192.168.133.66"};
            //int port = 8899;
            //int i = 0;
