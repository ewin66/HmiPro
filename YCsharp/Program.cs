...
namespace YCsharp {
    ...
    public class Program {
        static void Main(string[] args) {
            ...
            string[] hmi = new[] { "CA", "CB", "CC", "DA", "DB", "DE_DF", "DM", "ED", "EJ", "EK_EL", "EP", "RC_RF", "RG", "SA", "SB_SD", "SI_SG_BB", "TA_RE", "TB_TG", "VA_VC", "VB_VG", "VD", "VE_VF", "VH_VI", "VJ_VK", "EB", "CD", "MB", "PB", "MA", "E2", "E1", "EC","SC" };
            string[] ips = new[] { "192.168.130.66","192.168.131.66","192.168.132.66","192.168.200.66","192.168.201.66","192.168.110.66","192.168.202.66","192.168.180.66","192.168.183.66",
                ...
                "192.168.139.66","192.168.140.66","192.168.142.66","192.168.144.66","192.168.146.66","192.168.149.66","192.168.178.66","192.168.133.66","192.168.211.66","192.168.213.66","192.168.212.66","192.168.187.66","192.168.181.66","192.168.179.66","192.168.192.66"};
